...
{
    [TestFixture]
    public class DynamoDbMapperWithObjectListUsingCamelCaseUnderscoreFieldToDocumentTests : DynamoDbMapperWithObjectListUsingCamelCaseUnderscoreFieldBase
    {
        ...
        public override void SetUp()
        {
            ...
            foo.AddBar(new Bar {BarName = "BarName1"});
            foo.AddBar(new Bar {BarName = "BarName2"});
